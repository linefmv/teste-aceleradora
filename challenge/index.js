function addRow() {
  ...
  const firstSemesterValue = parseFloat(
    document.getElementById("firstSemesterNotes").value
  );
  const secondSemesterValue = parseFloat(
    document.getElementById("secondSemesterNotes").value
  );
  ...
  allAnswers.forEach((answer) => (answer.style.backgroundColor = "green"));
}
